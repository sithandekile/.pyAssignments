...
# My findings on DEATH RATE OVER TIME
United State has higher number of death rate at the beginning this might be because the healthy care system were ovewhelmed but over time the death rate dropped as the testing and treatment were rolled out then it was stabalized.

# My findings on CUMMULATIVE VACCINE OVER TIME
United States and Germany  shows the higher number of vaccination as tI believe thee we the first countries to get the medicine whilst botswana rollout was slow so the number of vaccination too

# My findings on TOP 10 COUNTRIES BY TOTAL CASES
Botawana and Colombia had fewer cases than United States and Germany as there we the top of the global hotspots

# My findings on VACCINATED vs UNVACCINATED
The number of vaccinated people on  my selected countries is higher than unvaccinated people this shows that people united to fight the covid19 pandemic
